...
This project is a fork of {fluend-pluging-detect-exceptions}[https://github.com/Financial-Times/fluent-plugin-detect-exceptions]. 
It has been adapted to also detect FT membership specific multiline exception logs. 

fluent-plugin-detect-memb-exceptions is an
...
{RubyGems.org}[https://rubygems.org/gems/fluent-plugin-detect-ft-memb-exceptions]
and can be installed using:

    $ gem install fluent-plugin-detect-ft-memb-exceptions
...
[languages]  A list of language for which exception stack traces shall be
             ...
             Supported values: java, js, csharp, python, go, ruby, php, elixir, all.
             Default: all.
...
If you make any changes to this gem, you will need to push your changes to rubygems.org.


$ gem build fluent-plugin-detect-ft-memb-exceptions.gemspec

$ gem push fluent-plugin-detect-ft-memb-exceptions-0.0.<your-version>.gem
