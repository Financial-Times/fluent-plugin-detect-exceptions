...
{RubyGems.org}[https://rubygems.org/gems/fluent-plugin-detect-memb-exceptions]
and can be installed using:

    $ gem install fluent-plugin-detect-memb-exceptions
...
$ gem build fluent-plugin-detect-memb-exceptions.gemspec

$ gem push fluent-plugin-detect-memb-exceptions-0.0.<your-version>.gem
